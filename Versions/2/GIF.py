    ...
    def run(self):
        try:
            ...
            creator.create_fade_gif(
                ...
                target_size=(1920, 1080)  # Force 1080p output
            )
...
class GifFadeCreator:
    ...
    def resize_images_to_match(self, images, target_size=None):
        """Resize all images to 1080p while maintaining aspect ratios and quality"""
        if target_size is None:
            # Use 1080p as default
        ...
        for img in images:
            ...
            # Create 1080p canvas and center the image
            canvas = Image.new('RGBA', target_size, (0, 0, 0, 0))  # Transparent background
